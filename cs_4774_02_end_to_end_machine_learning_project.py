...
def load_housing_data():
    ...
    return pd.read_csv(C:/Users/leons/OneDrive/Desktop/CS_ML/housing.csv, sep=" ", header=None,  names= ['CRIM', 'ZN', 'INDUS', 'CHAS', 'NOX', 'RM', 'AGE', 'DIS', 'RAD', 'TAX', 'full', 'PTRATIO', 'B', 'Bk','LSTAT','MEDV']
